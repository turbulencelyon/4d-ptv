function Submission_Center_Finding(ManipName,CamNum,FirstFrame,Nframes,Th,Sz,Session_INPUT,Session_OUTPUT)
...
%--------------------------------------------------------------------------------
%   How to run: 
%   Compile in matlab using: mcc -m Arg_CenterFinding2D_PSMN.m
%   Launch it in a terminal using: sh run_Arg_CenterFinding2D_PSMN.sh $MCRROOT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
